...
<body class="font-sans antialiased bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen">
    ...
    <div class="flex relative">
        ...
        <!-- Enhanced Sidebar -->
        <aside id="sidebar"
               class="overflow-y-auto bg-blue-900 text-blue-50 shadow-2xl fixed top-0 left-0 h-screen w-[280px] z-50 transition-all duration-300 ease-in-out transform -translate-x-full md:translate-x-0 border-r border-blue-700/50"
            ...
            <div class="flex-1 px-4 py-4 space-y-1">
                ...
                <div>
                    ...
                    @if (Auth::user()->role !== 'prefect')
                        <x-side-nav-link href="{{ route('dashboard') }}" 
                                         ...
                                         class="nav-item flex items-center px-4 py-3 rounded-xl mb-1 transition-all duration-200" 
                                         >
                    ...
                    @if (Auth::user()->role !== 'prefect')
                        <div class="mb-2">
                            <button id="toggleReports"
                                    class="nav-item w-full flex items-center justify-between px-4 py-3 rounded-xl text-left hover:bg-blue-700/30 transition-all duration-200 group"
                                    aria-expanded="false" aria-label="Toggle Reports menu">
                                <div class="flex items-center space-x-3">
                                    <div class="mini-icon w-6 flex justify-center transition-transform duration-200">
                                        <i class="fas fa-file-alt text-blue-200 group-hover:text-white"></i>
                                    </div>
                                    <span class="sidebar-text font-medium text-blue-100 group-hover:text-white transition-colors duration-200">Reports</span>
                                </div>
                                <svg xmlns="http://www.w3.org/2000/svg" 
                                     class="h-4 w-4 transition-transform duration-300 sidebar-text text-blue-300" 
                                     id="reportsArrow" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <div id="reportsDropdown" class="ml-6 mt-2 space-y-1 hidden overflow-hidden">
                                <x-side-nav-link href="{{ route('reports.index') }}" 
                                                 :active="request()->routeIs('reports.index')" 
                                                 class="nav-item flex items-center px-4 py-2.5 rounded-lg text-sm group">
                                    <div class="flex items-center space-x-3 w-full">
                                        <div class="w-6 flex justify-center">
                                            <i class="fas fa-list text-blue-300 group-hover:text-white text-sm"></i>
                                        </div>
                                        <span class="sidebar-text text-blue-200 group-hover:text-white transition-colors duration-200">All Reports</span>
                                    </div>
                                </x-side-nav-link>
                                
                                @if (in_array(Auth::user()->role, ['admin', 'super_admin']))
                                    <x-side-nav-link href="{{ route('reports.archived') }}" 
                                                     :active="request()->routeIs('reports.archived')" 
                                                     class="nav-item flex items-center px-4 py-2.5 rounded-lg text-sm group">
                                        <div class="flex items-center space-x-3 w-full">
                                            <div class="w-6 flex justify-center">
                                                <i class="fas fa-archive text-blue-300 group-hover:text-white text-sm"></i>
                                            </div>
                                            <span class="sidebar-text text-blue-200 group-hover:text-white transition-colors duration-200">Archived</span>
                                        </div>
                                    </x-side-nav-link>
                                @endif
                            </div>
                ...
                <div class="border-b border-blue-800 mb-4 md:mb-7"></div>
                    <div class="flex items-center space-x-2 px-4 py-2">
                        <h3 class="text-xs font-semibold text-blue-300 uppercase tracking-wider sidebar-text mt-4">System Integrate</h3>
                    </div>

                        <x-side-nav-link href="{{ route('student.index') }}" 
                            ...
                            <div class="flex items-center space-x-3 w-full relative">
                                <div class="mini-icon w-6 flex justify-center transition-transform duration-200">
                                    <i class="fas fa-user-graduate text-blue-200 group-hover:text-white"></i>
                                </div>
                                <span class="sidebar-text font-medium text-blue-100 group-hover:text-white transition-colors duration-200">Student List</span>
                            </div>
                        </x-side-nav-link>

                        @auth
                        @if (in_array(Auth::user()->role, ['prefect', 'super_admin', 'admin']))
                            <x-side-nav-link href="{{ route('prefect') }}" 
                                             :active="request()->routeIs('prefect')" 
                                             class="nav-item flex items-center px-4 py-3 rounded-xl mb-2" 
                                             >
                                <div class="flex items-center space-x-3 w-full">
                                    <div class="mini-icon w-6 flex justify-center transition-transform duration-200">
                                        <i class="fas fa-shield-alt text-blue-200 group-hover:text-white"></i>
                                    </div>
                                    <span class="sidebar-text font-medium text-blue-100 group-hover:text-white transition-colors duration-200">Prefect</span>
                                </div>
                            </x-side-nav-link>
                        @endif
                    @endauth
                    ...
                    @if (in_array(Auth::user()->role, ['super_admin', 'admin']))
                        <x-side-nav-link href="{{ route('clinic') }}" 
                                         :active="request()->routeIs('clinic')" 
                                         class="nav-item flex items-center px-4 py-3 rounded-xl mb-7 transition-all duration-200" 
                                         >
                            <div class="flex items-center space-x-3 w-full">
                                <div class="mini-icon w-6 flex justify-center transition-transform duration-200">
                                    <i class="fas fa-hospital text-blue-200 group-hover:text-white"></i>
                                </div>
                                <span class="sidebar-text font-medium text-blue-100 group-hover:text-white transition-colors duration-200">Clinic</span>
                            </div>
                        </x-side-nav-link>
                    @endif
                <div class="border-b border-blue-800 mb-4 md:mb-7"></div>        
                ...
                <div>
                    <div class="flex items-center space-x-2 px-4 py-2">
                        ...
                        <h3 class="text-xs font-semibold text-blue-300 uppercase tracking-wider sidebar-text mt-4">Campus Map</h3>
                    </div>
                    
                    <x-side-nav-link href="{{ route('incidents.map') }}" 
                                     :active="request()->routeIs('incidents.map')" 
                                     class="nav-item flex items-center px-4 py-3 rounded-xl mb-7" 
                                     >
                        <div class="flex items-center space-x-3 w-full">
                            <div class="mini-icon w-6 flex justify-center transition-transform duration-200">
                                <i class="fas fa-school text-blue-200 group-hover:text-white"></i>
                            </div>
                            <span class="sidebar-text font-medium text-blue-100 group-hover:text-white transition-colors duration-200">School Floor</span>
                        </div>
                    </x-side-nav-link>
                </div>
                <div class="border-b border-blue-800 mb-4 md:mb-7"></div>
                @if (Auth::user()->role !== 'prefect')
                    ...
                    <div>
                        <div class="flex items-center space-x-2 px-4 py-2">
                            ...
                            <h3 class="text-xs font-semibold text-blue-300 uppercase tracking-wider sidebar-text mt-4">Staff Directory</h3>
                        </div>
                        
                        <x-side-nav-link href="{{ route('employees.index') }}" 
                                         :active="request()->routeIs('employees.index')" 
                                         class="nav-item flex items-center px-4 py-3 rounded-xl mb-7" 
                                         >
                            <div class="flex items-center space-x-3 w-full">
                                <div class="mini-icon w-6 flex justify-center transition-transform duration-200">
                                    <i class="fas fa-user-tie text-blue-200 group-hover:text-white"></i>
                                </div>
                                <span class="sidebar-text font-medium text-blue-100 group-hover:text-white transition-colors duration-200">Employees</span>
                            </div>
                        </x-side-nav-link>
                    </div>
                @endif
                <div class="border-b border-blue-800 mb-4 md:mb-7"></div>
                @if (Auth::user()->role === 'admin' || Auth::user()->role === 'super_admin' || Auth::user()->role === 'officer')
                    <!-- Account Users Section -->
                    <div>
                        <div class="flex items-center space-x-2 px-4 py-2">
        
                            <h3 class="text-xs font-semibold text-blue-300 uppercase tracking-wider sidebar-text mt-4">Account Users</h3>
                        </div>
                        
                        <x-side-nav-link href="{{ route('users.index') }}" 
                                ...
                                <span class="sidebar-text font-medium text-blue-100 group-hover:text-white transition-colors duration-200">Users</span>
                            </div>
                        </x-side-nav-link>
                    </div>
                @endif
                                ...
                                <nav class="flex items-center text-sm text-gray-500" aria-label="Breadcrumb">
                                    <ol class="inline-flex items-center space-x-1">
                                        ...
                                        @foreach($segments as $index => $segment)
                                            @continue($index === 0 && $segment === 'dashboard')
                            ...
                            <div class="relative">
                                <button id="userDropdownButton"
                                    ...
                                    <div class="hidden sm:block text-left">
                                        <div class="truncate max-w-32">{{ Str::title(Auth::user()->name . ' ' . Auth::user()->middle_name . ' ' . Auth::user()->last_name . ' ' . Auth::user()->suffix) }}</div>
                ...
                Swal.fire({
                    ...
                    html: `
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            <button id="openCreateModal" class="quick-action-btn p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200">
                                <i class="fas fa-plus text-blue-600 text-2xl mb-2"></i>
                                <p class="text-sm font-medium text-blue-800">New Report</p>
                            </button>
                            <button id="openChatbot" class="quick-action-btn p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors duration-200">
                    ...
                    didOpen: () => {
                        ...
                        // Open the create modal and close Swal
                        document.getElementById('openCreateModal').addEventListener('click', () => {
                            Swal.close();  // Close the Swal popup first
                            // Open the actual modal by removing 'hidden'
    ...
    //     function unlockReports(e) {
    //     e.preventDefault();

    //     Swal.fire({
    //         title: 'Confirm Your Password',
    //         input: 'password',
    //         inputLabel: 'Enter your account password',
    //         inputPlaceholder: '••••••••',
